...
function CardDetail() {
  ...
  const facts: Array<[string, string]> = [
    ...
    ...(card.refundFeePct !== undefined ? [["退款", `${card.refundFeePct}%`] as [string, string]] : []),
    ...(card.reversalFeeUsd !== undefined ? [["撤销", `$${card.reversalFeeUsd}`] as [string, string]] : []),
    ...(card.chargebackFeeUsd !== undefined ? [["拒付", `$${card.chargebackFeeUsd}`] as [string, string]] : []),
