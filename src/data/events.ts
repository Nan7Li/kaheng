...
export const METHOD_NOTES = [
  ...
  "进阶档：用该卡最高一档的返现和磨损；达到等级往往还需资产、交易量或订阅。",
  "商户货币和卡结算币不同时计入 FX。台币刷美元卡会加价；欧元商户刷欧元卡不加。",
  "欧元卡、新币卡按自己的结算币折算，不再假装是美元卡。",
  "USDT / USDC / USDG 用交易所实时价，不默认 1 稳定币 = 1 美元。OKX 按 USDG 扣款。",
  "开卡费按 12 个月摊销；实体卡费用仅在选择“含实体卡费”时计入。",
  "充值、币种转换、消费费、FX 分开计算，避免把不同性质的费用混成一个数。",
  "返现若是平台币 / 积分，按面值计入——这会高估，细节见各卡说明。",
  "只有标记“官方已核”的条目才有官方来源；其余数字只作线索，下单前以 App 报价为准。",
];
