...
export const CARDS: UCard[] = [
  ...
  },
  {
    ...
    cashbackNote: "Core：每月前 $2,000 享 3% ETHFI，其后 1% / 0.5%；锁定 7 天，累计至少 $5 才可领取。",
    assets: ["USDC", "ETHFI"],
    ...
    cons: ["返现为 ETHFI 且锁 7 天", "非美元总换汇成本约 1%–1.5%", "官方发卡费页面互相冲突"],
  ...
  },
  {
    ...
    form: "both",
    status: "active",
    statusNote: "亚太 Visa BIN 493875。虚拟免费，实体约 5 USDT。APAC 无 Apple Pay，有 Google Pay。",
    category: "exchange",
    custody: "custodial",
    kyc: "passport",
  ...
  },
  {
    ...
    form: "both",
    status: "active",
    statusNote: "虚拟 $10、实体 $100。加密充值 0 费；消费时 1% 转换，非美元另加 1.2% FX。",
    category: "vcc",
    custody: "custodial",
    kyc: "basic",
  ...
  },
  {
    ...
    form: "virtual",
    status: "active",
    statusNote: "美区 BIN（波多黎各 Banco San Juan，454924）。年费 $20，充值 0.5%。",
    category: "wallet",
    custody: "custodial",
    kyc: "passport",
...
> = {
  ...
  bybit: { binCountry: "mixed", binCode: "493875", binIssuer: "亚太 Visa" },
  ...
  solayer: { binCountry: "pr", binIssuer: "Banco San Juan", binCode: "454924" },
